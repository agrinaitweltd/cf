          ...
          <div className={styles.grid}>
            ...
            <div className={styles.brand}>
              ...
              <div className={styles.socials}>
                {/* Facebook */}
                <a href="https://facebook.com/cfhubuk" aria-label="Facebook" className={styles.socialIcon} target="_blank" rel="noopener noreferrer">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/>
                  </svg>
                </a>
                {/* Instagram */}
                <a href="https://instagram.com/cfhubuk" aria-label="Instagram" className={styles.socialIcon} target="_blank" rel="noopener noreferrer">
                ...
                {/* LinkedIn */}
                <a href="https://linkedin.com/company/cfhubuk" aria-label="LinkedIn" className={styles.socialIcon} target="_blank" rel="noopener noreferrer">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                {/* X / Twitter */}
                <a href="https://twitter.com/cfhubuk" aria-label="X (Twitter)" className={styles.socialIcon} target="_blank" rel="noopener noreferrer">
            ...
            <div className={styles.col}>
              ...
              <div className={styles.contactList}>
                <div className={styles.contactItem}>
                  ...
                  </svg> <logo className="png"></logo>
                  <span>07960481933 <a href="tel:07960481933">Call Us</a></span>
                </div>
                <div className={styles.contactItem}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  ...
                  <span>enquiries@cfhubuk.com <a href="mailto:enquiries@cfhubuk.com">Email Us</a></span>
                </div>
                <div className={styles.contactItem}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <div className="container">
          <div className={styles.bottomInner}>
            <p className={styles.copy}>
              &copy; {year} CF HUB UK. All rights reserved.  Made & Developed By<a href="https://kavotech.uk" target="_blank" rel="noopener noreferrer">Kavo Tech Uk</a>  color: #FFFF;
