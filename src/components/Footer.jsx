              ...
              <div className={styles.contactList}>
                ...
                <div className={styles.contactItem}>
                  ...
                  <span>Serving all across the United Kingdom</span>
                          ...
                          {/* TikTok */}
                          <a href="https://www.tiktok.com/@cfhubuk" aria-label="TikTok" className={styles.socialIcon} target="_blank" rel="noopener noreferrer">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                          ...
                          <span className={styles.socialHandle}>@cfhubuk</span>
            </div>
