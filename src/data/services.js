export const services = [
  {
    ...
    includes: [
      ...
      'Flooring installation â€” hardwood, laminate, tile and stone',
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Do I need to move all furniture before you start?', a: 'No â€” we move and protect all furniture as part of our service. We ask that very valuable or fragile items are removed to a safe location beforehand.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Can you handle multiple small jobs in one visit?', a: 'Absolutely â€” that\'s the most efficient way to use our handyman service. Just send us your list of jobs and we\'ll assess whether they can all be completed in a single visit.' },
  ...
  },
  {
    ...
    faq: [
      { q: 'What should I do in a plumbing emergency?', a: 'First, locate and turn off your stopcock (usually under the kitchen sink or outside the front of the property) to stop the water supply. Then call us â€” we provide 24/7 emergency response for urgent plumbing failures.' },
      { q: 'Do you need to be Gas Safe registered to service a boiler?', a: 'Yes â€” by UK law, anyone working on gas appliances must be on the Gas Safe Register. All our gas engineers are fully registered and can provide their registration details on request.' },
      ...
      { q: 'Can you fix a dripping tap or is that too small a job?', a: 'No job is too small. A dripping tap wastes significant water over time and can indicate wider issues. We\'re happy to attend for small repairs â€” just combine it with any other maintenance items to maximise your visit.' },
    ],
  },
]
