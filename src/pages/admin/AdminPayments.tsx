    ...
    <>
      ...
      <div className={styles.dataCard}>
        <div className={styles.dataCardHead}>
          ...
          <p className={styles.dataCardSubtitle}>Track successful and failed Clean Club payments.</p>
        </div>
                ...
                {pageItems.map(p => {
                  ...
                  return (
                    <tr key={p.id}>
                      ...
                      <td>
                        <span className={`${styles.statusDot} ${p.status === 'paid' ? styles.dotActive : styles.dotWarn}`} />
